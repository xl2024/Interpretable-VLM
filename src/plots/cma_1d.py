...
def run_mediation_analysis(
    ...
    token_inputs_1 = processor(text="<image>\nIn this image there is a blue", images=image_c1, return_tensors="pt")
    token_inputs_2 = processor(text="<image>\nIn this image there is a blue circle", images=image_c1, return_tensors="pt")
    ...
    a1_inputs_1 = processor(text=f"{prompt} red", images=image_c1, return_tensors="pt")
    a1_star_inputs_2 = processor(text=f"{prompt} blue", images=image_c1, return_tensors="pt")
    ...
    token_inputs = processor(text=prompt, images=image_c1, return_tensors="pt")
